...
def main():
    ...
    infinite_system_algorithm(L=500, m=150, target_Sz=1)
    #finite_system_algorithm(L=500, m_warmup=10, m_sweep_list=[10, 20, 30, 40, 50], target_Sz=1)
